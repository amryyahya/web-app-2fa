...
secret_key = b'PZ9nxEKzErFWCJzY' # yang dicari
...
for combo in compinations:
    ...
    print(getTOTP(tried_secret, message=b'\x00\x00\x00\x00\x03b\x85\xbf'))
    if getTOTP(tried_secret, message=b'\x00\x00\x00\x00\x03b\x85\xbf') == '930075':
        print(tried_secret)

#percobaan selama 
#tidak didapatkan secret key yang menghasilkan nilai yang sama dengan TOTP